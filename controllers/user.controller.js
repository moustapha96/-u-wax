...
module.exports.follow = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ follower: req.params.id, following: req.body.idToFollow });
    } catch (err) {
        return res.status(500).json({ message: err });
    }
};
...
module.exports.unfollow = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ follower: req.params.id, unfollowing: req.body.idToUnfollow });
